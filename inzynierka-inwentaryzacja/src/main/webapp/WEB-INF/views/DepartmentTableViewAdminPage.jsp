	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Działy</li>
			</ol>
			<!-- Add new -->
			...
			<div class="modal fade" id="AddNewModal" tabindex="-1" role="dialog" aria-labelledby="AddNewModalLabel"
				...
				<div class="modal-dialog" role="document">
					<form class="form" action="/departments/add" method="post">
						<input type="hidden" name="AddNewModal" value="AddNewModal" />
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="AddNewModalLabel">Dodaj nowy dział:</h5>
								...
								<div class="form-group">
									<label for="name">Podaj nazwe:</label>
									 <input type="text" class="form-control"
										id="name" placeholder="Nazwa działu" name="name">
								</div>
								</div>
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-table"></i> Baza działów
				</div>
				<div class="card-body">
